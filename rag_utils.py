...
def ollama_embed(texts, model=EMBED_MODEL):
    vectors = []
    ...
    for text in texts:
        ...
        # 2. если новый не найден — пробуем старый
        ...
        if "embeddings" in data:
            ...
            raise ValueError(f"Неожиданный ответ Ollama: {data}")
